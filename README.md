...
**RobomationLAB** 사용자들을 위한 [User Guide Wiki](https://github.com/RobomationLAB/User_Guide/wiki) 입니다.<br>
...
이 설명서에 명시적으로 표기된 경우를 제외하고, 이 설명서의 어떠한 내용도 로보메이션이 인명 또는 재산 손실, 손상 또는 특정 목적에의 적합성에 대한 보장이나 보증을 하는 것으로 해석될 수 없습니다.<br>
로보메이션은 어떠한 경우에도 이 설명서와 여기에 설명된 제품을 사용하여 발생하는 우발적 또는 결과적 손해에 대해 책임을 지지 않습니다.<br>
